...
<div class="hero is-cover is-relative is-fullheight is-default is-bold">
	...
	<div class="Wallop Wallop--fade">
		<div class="Wallop-list">
			<!-- Slide -->
			<div
				class="Wallop-item Wallop-item--current has-background-image"
				data-background="https://via.placeholder.com/1920x1080"
				data-demo-background="assets/img/startup/meetup.jpg"
			>
							...
							<div class="column is-5">
								<div class="caption-inner">
									...
									<div class="caption-text">
										<span
											>Nowadays, data management has become the key for
										...
										<div class="action">
											<a
												href="#services"
												class="button button-cta primary-btn rounded"
												>Get started now</a
											>
										</div>
									</div>
			...
			<div
				...
				data-background="https://via.placeholder.com/1920x1080"
				data-demo-background="assets/img/startup/meetup2.jpg"
			>
				<div class="Wallop-overlay"></div>
				<div class="Wallop-caption-wrapper">
					<div class="container">
						<div class="columns is-gapless is-vcentered">
							<div class="column is-5">
								<div class="caption-inner">
									<h1>Make solid decisions</h1>
									<div class="caption-divider"></div>
									<div class="caption-text">
										<span
											>Managing data flows inside a company is almost as
											managing blood streams. We give you tool to delegate
											data processing. You only, get the result and focus on
											your work.</span
										>
										<div class="action">
											<a
			...
			<div
				class="Wallop-item has-background-image"
				data-background="https://via.placeholder.com/1920x1080"
				data-demo-background="assets/img/startup/meetup3.jpg"
			>
				<div class="Wallop-overlay"></div>
				<div class="Wallop-caption-wrapper">
					<div class="container">
						<div class="columns is-gapless is-vcentered">
							<div class="column is-5">
								<div class="caption-inner">
									<h1>Scale when needed</h1>
									<div class="caption-divider"></div>
									<div class="caption-text">
										<span
											>You can start at a low scale to manage your daily
											operations and activity. However, our solution is
											designed to be fully scalable. It scales seamlessly as
											your business grows.</span
										>
										<div class="action">
											<a
												href="#services"
			...
			<ul>
				<li>
					<a
						><img
							class="partner-logo"
							src="assets/img/logos/custom/covenant.svg"
							alt=""
					/></a>
				</li>
				<li>
					<a
						><img
							class="partner-logo"
							src="assets/img/logos/custom/infinite.svg"
							alt=""
					/></a>
				</li>
				<li>
					<a
						><img
							class="partner-logo"
							src="assets/img/logos/custom/phasekit.svg"
							alt=""
					/></a>
				</li>
				<li>
					<a
						><img
							class="partner-logo"
							src="assets/img/logos/custom/grubspot.svg"
							alt=""
					/></a>
				</li>
				<li>
					<a
						><img
							class="partner-logo"
							src="assets/img/logos/custom/gutwork.svg"
							alt=""
					/></a>
				</li>
			</ul>
	...
	<div class="container">
		...
		<div class="section-title-wrapper">
			...
			<div class="subtitle has-text-centered is-tablet-padded">
				We are a Data processing automation company.
			</div>
		</div>
		...
		<div class="content-wrapper">
			<div class="columns is-vcentered is-multiline has-text-centered">
				...
				<div class="column is-3">
					<div class="startup-icon-box">
						...
						<div class="box-title">Global analytics</div>
						<p class="box-content is-tablet-padded">
							Lorem ipsum dolor sit amet, eam ex probo tation tractatos. Ut
							vel hinc solet tincidunt, nec et iisque placerat pertinax.
						</p>
					</div>
				</div>
				<!-- Icon block -->
				<div class="column is-3">
					<div class="startup-icon-box">
						...
						<div class="box-title">App analytics</div>
						<p class="box-content is-tablet-padded">
							Lorem ipsum dolor sit amet, eam ex probo tation tractatos. Ut
							vel hinc solet tincidunt, nec et iisque placerat pertinax.
						</p>
				...
				<div class="column is-3">
					<div class="startup-icon-box">
						<div class="is-icon-reveal">
							<i class="im im-icon-File-Chart"></i>
						</div>
						<div class="box-title">Business analytics</div>
						<p class="box-content is-tablet-padded">
							Lorem ipsum dolor sit amet, eam ex probo tation tractatos. Ut
							vel hinc solet tincidunt, nec et iisque placerat pertinax.
						</p>
				...
				<div class="column is-3">
					<div class="startup-icon-box">
						...
						<div class="box-title">Finance Analytics</div>
						<p class="box-content is-tablet-padded">
							Lorem ipsum dolor sit amet, eam ex probo tation tractatos. Ut
							vel hinc solet tincidunt, nec et iisque placerat pertinax.
						</p>
			...
			<div class="has-text-centered is-title-reveal pt-20 pb-20">
				<a href="javascript:;" class="button button-cta primary-btn rounded raised"
					>Learn more</a
				>
			</div>
		</div>
...
<div class="section section-feature-grey is-medium">
	<div class="container">
		...
		<div class="section-title-wrapper">
			...
			<div class="subtitle has-text-centered is-tablet-padded">
				Create your own data widgets to build your own and specific
				dashboard. Make it fit your needs perfectly.
			</div>
		</div>
		<div class="content-wrapper">
			<!-- Row -->
			<div class="columns is-vcentered">
				...
				<div class="column is-7">
					<div>
						<figure class="image is-4-by-3">
							<img
								class="first"
								src="assets/img/illustrations/interface/analytic-widgets.png"
								alt=""
							/>
						</figure>
					</div>
				...
				<div class="column is-4 is-offset-1">
					<div class="icon-subtitle">
						<i class="im im-icon-Bar-Chart5"></i>
					</div>
					...
					<div class="pt-10 pb-10">
						<a
							href="javascript:;"
							class="button btn-align btn-more is-link color-primary is-title-reveal"
						>
...
<section class="section section-light-grey is-medium">
	<div class="container">
		...
		<div class="section-title-wrapper">
			...
			<div class="subtitle has-text-centered is-tablet-padded">
				You can immediatly create a Free account to start using our app. You
		...
		<div class="content-wrapper">
			...
			<div class="has-text-centered">
				<a
					id="show-video"
					class="button button-action btn-align rounded raised primary-btn"
				>
					<i class="fa fa-play"></i> See how our product works
				</a>
				<a
					id="show-mockup"
					class="button button-action btn-align rounded raised secondary-btn is-hidden"
				>
			...
			<div class="columns">
				...
				<div id="mockup" class="column">
					...
					<div class="mockup-dots is-hidden-touch">
						...
						<div class="dot-tip tip-first gelatine">
							Simple and modular UI
						</div>
						<div class="dot second is-dot-reveal"></div>
						<div class="dot-tip tip-second gelatine">
					...
					<img
						...
						src="assets/img/illustrations/interface/app-mockup.png"
						alt=""
					/>
				</div>
				<!-- /Mockup -->
				...
				<div
					id="video"
					class="column is-6 is-offset-3 animated preFadeInUp fadeInUp is-hidden pt-80 pb-80"
				>
...
<section class="section is-medium no-padding-bottom">
	<div class="container">
		...
		<div class="section-title-wrapper">
			...
			<div class="subtitle has-text-centered is-tablet-padded">
				Our team is made of IT professionnals and business specialists, the
				perfect recipe for success and collaboration.
			</div>
		</div>
			...
			<div class="columns">
				...
				<div class="column is-7">
					<img
						...
						alt=""
						data-demo-src="assets/img/startup/team.png"
					/>
				</div>
				<!-- Content -->
				<div class="column is-4 is-offset-1 pt-80 pb-80 mobile-padding-20">
					<div class="icon-subtitle">
						<i class="im im-icon-Reload-3"></i>
					</div>
...
<section class="section section-feature-grey is-medium">
	<div class="container">
		...
		<div class="section-title-wrapper">
			...
			<div class="subtitle has-text-centered is-tablet-padded">
				Discover many outstanding features, such as document management,
				advanced search and version history.
			</div>
		</div>
		...
		<div class="content-wrapper">
			...
			<div class="columns is-vcentered">
				...
				<div class="column is-7 has-text-centered">
					<img
						class="featured-svg"
						src="assets/img/illustrations/interface/add-docs.png"
						alt=""
					/>
				</div>
				...
				<div class="column is-5">
					...
					<h2 class="title feature-title bordered dark-text">
						Upload files
					</h2>
					...
					<span class="section-feature-description"
						...
						inermis iudicabit. Ex vidit fierent hendrerit eum, sed stet
						periculis ut. Vis in probo decore labitur. Unum simul an vis,
						tale patrioque eos ad, dicunt percipit ea nam. Vis dolor quidam
						assentior te, atomorum posidonium qui an.</span
					>
					<div class="pt-10 pb-10">
						<a
							href="javascript:;"
			...
			<div class="columns is-vcentered">
				<!-- Featured image -->
				<div
					class="column is-7 has-text-centered is-hidden-desktop is-hidden-tablet"
				>
					<img
						class="featured-svg"
						src="assets/img/illustrations/interface/bars.png"
						alt=""
					/>
				</div>
			...
			<div class="columns is-vcentered">
				...
				<div class="column is-7 has-text-centered">
					<img
						class="featured-svg"
						src="assets/img/illustrations/interface/table.png"
						alt=""
					/>
				</div>
			...
			<h2 class="title has-text-centered is-title-reveal">
				<a
					href="features.html"
					class="button button-cta btn-align rounded raised primary-btn"
				>
					See all Features
				</a>
			</h2>
...
<section class="section section-light-grey is-medium">
	<div class="container">
		...
		<div class="section-title-wrapper">
			...
			<div class="subtitle has-text-centered is-tablet-padded">
				Our support team will do everything to make you feel comfortable
				with our application and services. Just ask them !
			</div>
		</div>
		...
		<div class="content-wrapper">
			<div class="columns">
				...
				<div class="column is-one-third">
					<div
						class="feature-card card-md is-startup light-bordered hover-inset has-text-centered is-card-reveal"
					>
						<!-- Card icon -->
						<div class="card-icon">
							<img src="assets/img/icons/lifesaver.svg" alt="" />
						</div>
						<!-- Content -->
						...
						<div class="card-feature-description">
							<span class=""
								>Lorem ipsum dolor sit amet, clita laoreet ne cum. His
								caelus elet cu harum inermis iudicabit.</span
							>
						</div>
						<a
							href="javascript:;"
							class="button btn-align btn-more is-link color-primary mt-10 mb-10"
						>
...
<section
	...
	class="section parallax is-relative is-medium"
	data-background=""
	data-color="#000"
...
>
	<div class="container">
		...
		<div class="section-title-wrapper">
			...
			<div class="subtitle has-text-centered is-tablet-padded">
				Just take a look at what our clients say about us. We thank them a
				lot for top ranking us and for using our solutions.
			</div>
		</div>
				...
				<div class="column is-10">
					...
					<div class="columns is-vcentered">
						<div class="column is-6">
							<!-- Testimonial item -->
							<div
								class="flex-card testimonial-card light-bordered light-raised padding-20"
							>
								...
								<div class="user-id">
									<img
										...
										alt=""
										data-demo-src="assets/img/startup/avatars/dan.png"
									/>
									<div class="info">
							...
							>
								...
								<div class="user-id">
									<img
										...
										src="https://via.placeholder.com/250x250"
										alt=""
										data-demo-src="assets/img/startup/avatars/janet.jpg"
									/>
									<div class="info">
							...
							>
								...
								<div class="user-id">
									<img
										...
										src="https://via.placeholder.com/250x250"
										alt=""
										data-demo-src="assets/img/startup/avatars/helen.jpg"
									/>
									<div class="info">
							...
							>
								...
								<div class="user-id">
									<img
										...
										src="https://via.placeholder.com/250x250"
										alt=""
										data-demo-src="assets/img/startup/avatars/anthony.jpg"
									/>
									<div class="info">
				...
				<div class="columns is-vcentered">
					...
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/taskbot.svg"
								alt=""
						/></a>
					</div>
					<!-- Client -->
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/systek.svg"
								alt=""
						/></a>
					</div>
					<div class="column is-hidden-mobile"></div>
				...
				<div class="columns is-vcentered is-separator">
					...
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/tribe.svg"
								alt=""
						/></a>
					</div>
					<!-- Client -->
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/powerball.svg"
								alt=""
						/></a>
					</div>
					<!-- Client -->
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/kromo.svg"
								alt=""
						/></a>
					</div>
					<!-- Client -->
				...
				<div class="columns is-vcentered is-separator">
					...
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/bitbreaker.svg"
								alt=""
						/></a>
					</div>
					<!-- Client -->
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/evently.svg"
								alt=""
						/></a>
					</div>
					<!-- Client -->
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/proactive.svg"
								alt=""
						/></a>
					</div>
					<!-- Client -->
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/transfuseio.svg"
								alt=""
						/></a>
					</div>
					<!-- Client -->
					<div class="column">
						<a
							><img
								class="client"
								src="assets/img/logos/custom/livetalk.svg"
								alt=""
						/></a>
					</div>
					<div class="column is-hidden-mobile"></div>
