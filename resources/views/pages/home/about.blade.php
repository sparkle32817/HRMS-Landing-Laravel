      ...
      <div class="columns is-vcentered">
        <div class="column is-6 is-offset-3 has-text-centered">
          ...
          <h2 class="subtitle is-4 light-text pt-10 pb-10">
            We are a young company but we grew fast, thanks to the support
            of all our valuable cutomers.
          </h2>
          <br />
        </div>
      </div>
...
<!-- Founders section -->
<div class="section is-medium no-padding-bottom">
  <div class="container">
    <!-- Title -->
    <div class="section-title-wrapper">
      ...
      <div class="subtitle has-text-centered is-tablet-padded">
        Our company started with a brilliant but simple idea, give you
        insight on whatever you want.
      </div>
    </div>
      ...
      <div class="columns">
        ...
        <div class="column is-7">
          <img
            ...
            alt=""
            data-demo-src="assets/img/startup/founders.png"
          />
        </div>
        <!-- Content -->
...
<div class="section section-feature-grey is-medium">
  <div class="container">
    <div
      class="columns values-cards is-minimal is-vcentered is-gapless is-multiline"
    >
      <!-- Card -->
      <div class="column">
        <div
          class="feature-card card-md hover-inset has-text-centered mb-20"
        >
          <div class="card-icon">
          ...
          <div class="card-feature-description">
            <span class=""
              >Lorem ipsum dolor sit amet, clita laoreet ne cum. His caelus
              elet cu harum inermis iudicabit.</span
            >
          </div>
        </div>
      </div>
      ...
      <div class="modern-team startup-team">
        ...
        <article class="modern-team-item circle-mask zoom-effect">
          <div class="item-wrapper">
            <div class="item-img">
              <img
                src="https://via.placeholder.com/529x643"
                class="member-avatar"
                alt=""
                data-demo-src="assets/img/startup/team/startup-t3.jpg"
              />
            </div>
          ...
          <div class="item-wrapper">
            <div class="item-img">
              <img
                ...
                class="member-avatar"
                alt=""
                data-demo-src="assets/img/startup/team/startup-t1.jpg"
              />
            </div>
            <div class="overlay-wrapper">
              <div>
          ...
          <div class="item-wrapper">
            <div class="item-img">
              <img
                ...
                class="member-avatar"
                alt=""
                data-demo-src="assets/img/startup/team/startup-t4.jpg"
              />
            </div>
            <div class="overlay-wrapper">
              <div>
          ...
          <div class="item-wrapper">
            <div class="item-img">
              <img
                ...
                class="member-avatar"
                alt=""
                data-demo-src="assets/img/startup/team/startup-t2.jpg"
              />
            </div>
            <div class="overlay-wrapper">
              <div>
          ...
          <div class="item-wrapper">
            <div class="item-img">
              <img
                ...
                class="member-avatar"
                alt=""
                data-demo-src="assets/img/startup/team/startup-t5.jpg"
              />
            </div>
            <div class="overlay-wrapper">
              <div>
          ...
          <div class="item-wrapper">
            <div class="item-img">
              <img
                ...
                class="member-avatar"
                alt=""
                data-demo-src="assets/img/startup/team/startup-t6.jpg"
              />
            </div>
            <div class="overlay-wrapper">
              <div>
...
<div
  ...
  data-background="https://via.placeholder.com/1920x1077"
  data-color="#000"
  data-color-opacity="0.7"
  data-demo-background="assets/img/startup/office.jpg"
>
  <div class="container">
    <!-- Title -->
    <div class="section-title-wrapper">
      <div class="bg-number">3</div>
      <h2 class="title section-title has-text-centered light-text">
        Let's work Together
      </h2>
      <div class="subtitle has-text-centered light-text is-tablet-padded">
        We work with companies all over the world. Join the experience and
        become one of our valuable partners.
      </div>
    </div>
    <!-- Title -->
      ...
      <div class="columns is-vcentered has-text-centered">
        <div class="column is-4">
          <div class="parallax-counter is-primary">
            ...
            <div class="counter counter-number text-bold">25</div>
        ...
        <div class="column is-4">
          <div class="parallax-counter is-primary">
            ...
            <div class="counter counter-number text-bold">7987</div>
    ...
    <div class="columns">
      <div class="column is-8 is-offset-2 is-12-mobile">
        ...
        <div class="vertical-testimonials">
          <!-- Testimonial item -->
          <div
            class="flex-card vtestimonial-item light-bordered padding-20"
          >
            <div class="content content-flex">
              <img
                class="vt-avatar is-hidden-mobile"
              ...
              <div class="vt-content">
                ...
                <div class="vt-text">
                  Lorem ipsum dolor sit amet, ex vis laoreet perfecto
                  insolens. Pericula repudiandae.
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div class="content content-flex">
              <img
                ...
                src="https://via.placeholder.com/250x250"
                alt=""
                data-demo-src="assets/img/startup/avatars/terry.jpg"
              />
              <div class="vt-content">
                <div class="star-rating color-secondary is-hidden-mobile">
                  <i class="fa fa-star"></i>
                ...
                <div class="vt-text">
                  Lorem ipsum dolor sit amet, ex vis laoreet perfecto
                  insolens. Pericula repudiandae vel no, ne sonet.
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div class="content content-flex">
              ...
              <div class="vt-content">
                ...
                <div class="vt-text">
                  Lorem ipsum dolor sit amet, ex vis laoreet perfecto
                  insolens. Pericula repudiandae vel no.
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div class="content content-flex">
              <img
                ...
                src="https://via.placeholder.com/250x250"
                alt=""
                data-demo-src="assets/img/startup/avatars/kareem.jpg"
              />
              <div class="vt-content">
                <div class="star-rating color-secondary is-hidden-mobile">
                  <i class="fa fa-star"></i>
                ...
                <div class="vt-text">
                  Lorem ipsum dolor sit amet, ex vis laoreet perfecto
                  insolens. Pericula repudiandae vel no, ne sonet viderer
                  vis.
                </div>
              </div>
            </div>
          ...
          >
            <div class="content content-flex">
              <img
                ...
                src="https://via.placeholder.com/250x250"
                alt=""
                data-demo-src="assets/img/startup/avatars/thomas.jpg"
              />
              <div class="vt-content">
                <div class="star-rating color-secondary is-hidden-mobile">
                  <i class="fa fa-star"></i>
          ...
          >
            <div class="content content-flex">
              <img
                ...
                src="https://via.placeholder.com/250x250"
                alt=""
                data-demo-src="assets/img/startup/avatars/sally.jpg"
              />
              <div class="vt-content">
                <div class="star-rating color-secondary is-hidden-mobile">
                  <i class="fa fa-star"></i>
...
<!-- Clients -->
<div id="trust" class="section section-feature-grey is-medium">
  <div class="container">
    <div class="section-title-wrapper">
      <div class="bg-number">
        <i class="material-icons is-gigantic">domain</i>
      </div>
      <h2 class="title section-title has-text-centered dark-text">
        We build Trust.
      </h2>
    ...
    <div class="content-wrapper">
      ...
      <div class="has-text-centered pt-60 pb-60">
        <a
          href="startup-signup.html"
          class="button button-cta btn-align primary-btn raised rounded is-title-reveal"
          >Get started Now</a
        >
      </div>
      <!-- /CTA -->
