...
<div class="login-wrapper columns is-gapless">
  ...
  <div class="column login-column is-8 is-hidden-mobile hero-banner">
    <div
      class="hero login-hero is-fullheight has-background-image"
    ...
    <div class="hero is-fullheight">
      <div class="hero-heading">
        ...
        <div class="no-account-link has-text-centered">
          <a href="startup-signup.html"
            ><i class="sl sl-icon-question pr-10"></i> I do not have an
            account yet
          </a>
        </div>
      </div>
        ...
        <div class="container">
          <div class="columns">
            <div class="column is-8 is-offset-2">
              ...
              >
                <p class="has-text-centered">
                  <a href="javascript:;">Back to Sign in</a>
                </p>
              </div>
            </div>
          </div>
